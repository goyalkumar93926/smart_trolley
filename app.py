...
RENDER_BASE_URL = "https://smart-trolley-backend-ohfl.onrender.com"  # Replace with your actual Render URL
...
def send_whatsapp(message, phone):
    try:
        with app.app_context():  # Ensures request context is active
...
def generate_bill():
    ...
    if user:
        ...
        message += f"Total: ₹{total}\n👉 Pay Now: https://smart-trolley-backend-ohfl.onrender.com/payment/{bill_id}"
